...
export function LandingPage(props: { connection: Connection; error?: string; onOpenSettings: () => void }): JSX.Element {
  ...
  return (
    <main className="landing-page">
      ...
      <footer className="landing-footer"><span>OBSERVER / 0.9.15</span><span>CC0 POCKET WATCH / POLY HAVEN</span><span>MADE FOR PEOPLE WHO RUN AGENTS</span><a href="#top">BACK TO TOP ↑</a></footer>
    </main>
  )
}
